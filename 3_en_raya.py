...
turnojugador=ttk.Label(root,text="  ¡Turno del jugador 1!  ")
turnojugador.grid(row=3,column=0,sticky='snew',ipadx=40,ipady=40)



res=ttk.Button(root,text='Reiniciar')
...
def restartbutton():
    ...
    b=0
    c=0
    turnojugador['text']="   ¡Turno jugador 1!   "
    bu1['text']=' '
    bu2['text']=' '
    bu3['text']=' '
    bu4['text']=' '
...
def ButtonClick(id):
    ...
    if( bu1['text']=='X' and bu2['text']=='X' and bu3['text']=='X' or
        ...
        bu3['text']=='X' and bu5['text']=='X' and bu7['text']=='X'):
            disableButton()
            c=1
            tkinter.messagebox.showinfo("Tres en raya","El ganador es el jugador 1")
        ...
        bu3['text']=='O' and bu5['text']=='O' and bu7['text']=='O'):
            disableButton()
            c=1
            tkinter.messagebox.showinfo("Tres en raya","El ganador es el jugador 2")
    elif b==9:
            disableButton()
            c=1
            tkinter.messagebox.showinfo("Tres en raya","Empate")

    if a==1 and c==0:
        turnojugador['text']="   ¡Turno jugador 1!   "
    elif a==0 and c==0:
        turnojugador['text']="  ¡Turno jugador 2!   "
